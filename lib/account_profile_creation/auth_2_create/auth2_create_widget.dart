                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'wg04waki' /* Créer un compte en utilisant l... */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'AUTH_2_CREATE_CRER_UN_COMPTE_BTN_ON_TAP');
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'jzbcdhhs' /* Ou vous connecter avec */,
                                  ),
                                  textAlign: TextAlign.center,
                                  style: FlutterFlowTheme.of(context)
                                      .labelLarge
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  context.goNamedAuth(
                                      'Profil', context.mounted);
                                },
                                text: FFLocalizations.of(context).getText(
                                  'anvzvc2k' /* Continue with Google */,
                                ),
                                icon: FaIcon(
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'AUTH_2_CREATE_RichText_6rqrf49q_ON_TAP');
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            '6nnivb30' /* Possédez-vous déjà un compte ? */,
                                          ),
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
