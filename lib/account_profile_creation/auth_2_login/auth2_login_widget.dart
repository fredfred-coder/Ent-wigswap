...
class _Auth2LoginWidgetState extends State<Auth2LoginWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('AUTH_2_LOGIN_auth_2_Login_ON_INIT_STATE');
      logFirebaseEvent('auth_2_Login_request_permissions');
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '9otbeso3' /* "Remplissez les informations c... */,
                                ),
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'AUTH_2_LOGIN_SE_CONNECTER_BTN_ON_TAP');
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'AUTH_2_LOGIN_CONTINUER_AVEC_GOOGLE_BTN_O');
                                  logFirebaseEvent('Button_auth');
                                  GoRouter.of(context).prepareAuthEvent();
                                ...
                                text: FFLocalizations.of(context).getText(
                                  'rqsvvgv9' /* Continuer avec Google */,
                                ),
                                icon: FaIcon(
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'AUTH_2_LOGIN_RichText_iirhofgd_ON_TAP');
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'AUTH_2_LOGIN_MOT_DE_PASSE_OUBLI_BTN_ON_T');
                                  logFirebaseEvent('Button_navigate_to');

                                  context.pushNamed('auth_2_ForgotPassword');
                                },
                                text: FFLocalizations.of(context).getText(
                                  'ym8y4aea' /* Mot de passe oublié? */,
                                ),
                                options: FFButtonOptions(
                                  width: double.infinity,
                                  height: 44.0,
