...
class PostsRecord extends FirestoreRecord {
  ...
  // "usersPicture" field.
  String? _usersPicture;
  String get usersPicture => _usersPicture ?? '';
  bool hasUsersPicture() => _usersPicture != null;
  ...
  void _initializeFields() {
    ...
    _usersPicture = snapshotData['usersPicture'] as String?;
...
class PostsRecordDocumentEquality implements Equality<PostsRecord> {
  ...
  bool equals(PostsRecord? e1, PostsRecord? e2) {
    ...
    return e1?.postPhoto == e2?.postPhoto &&
        ...
        e1?.usersPicture == e2?.usersPicture &&
