                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            ...
                            _model.apiResultriw = await WaveCall.call();
                            if (_model.apiResultriw?.succeeded ?? true) {
                              _model.apiResultriw?.streamedResponse?.stream
                            ...
                            if ((_model.apiResultriw?.succeeded ?? true)) {
                              ...
                              await PaiementRecord.collection.doc().set({
                                ...createPaiementRecordData(
                                  userId: currentUserUid,
                                  amount: '1000 Fcfa',
                                  statuts: '\"Payement accepté\"',
