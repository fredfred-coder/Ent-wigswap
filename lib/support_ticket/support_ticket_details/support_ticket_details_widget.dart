                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                '5ydhl662' /* Vous trouverez ci-dessous les ... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                ...
                                if (widget!.ticketRef?.image != null &&
                                  ...
                                  Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'SUPPORT_TICKET_DETAILS_Image_crxd9dbt_ON');
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        FFLocalizations.of(context).getText(
                                          'vv9g4p7r' /* Dernière modification */,
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                      ...
                                      Padding(
                                        ...
                                        child: FlutterFlowDropDown<String>(
                                          ...
                                          hintText: FFLocalizations.of(context)
                                              .getText(
                                            '8plyz2tq' /* Veuillez sélectionner... */,
                                          ),
                                          icon: Icon(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'axi67a83' /* Note du développeur (supprimer... */,
                                                ),
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyLarge
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    '9s6vn3at' /* Vous devrez modifier la référe... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .labelSmall
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'SUPPORT_TICKET_DETAILS_ATTRIBUER_BTN_ON_');
                                                  logFirebaseEvent(
                                                      'Button_bottom_sheet');
                                          ...
                                          Expanded(
                                            child: Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'SUPPORT_TICKET_DETAILS_METTRE__JOUR_LE_T');
                                                  logFirebaseEvent(
                                                      'Button_backend_call');
                                                ...
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '665p4vus' /* Mettre à jour le ticket */,
                                                ),
                                                options: FFButtonOptions(
                                                  height: 48.0,
                                                  padding: EdgeInsetsDirectional
